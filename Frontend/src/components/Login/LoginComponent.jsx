          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
            ...
            <form className="mt-12 space-y-6">
              ...
              <div className="!mt-12">
                <button
                  type="button"
                  className="w-full py-2 px-4 text-[15px] font-medium tracking-wide rounded-md text-white bg-green-600 hover:bg-blue-700 focus:outline-none cursor-pointer"
                >
                  Sign in
                </button>
              </div>
              ...
              <p className="text-slate-900 text-sm !mt-6 text-center">
                ...
                <a
                  href="#"
                  className="text-green-800 hover:underline ml-1 whitespace-nowrap font-semibold"
                >
                  Register here
                </a>
              </p>
